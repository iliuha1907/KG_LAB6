...
public class LetterPresenter {
    ...
    private void setupKeyEventManager() {
        ...
        this.keyEventManager.addHandler(KeyCode.V, e -> this.verticalPlane());
        this.keyEventManager.addHandler(KeyCode.H, e -> this.horizontalPlane());
        this.keyEventManager.addHandler(KeyCode.D, e -> this.defaultPlane());
    }

    private void defaultPlane() {
        letterView.rotateDefault();
    }

    private void horizontalPlane() {
        letterView.rotateHorizontal();
    }

    private void verticalPlane() {
        letterView.rotateVertical();
    }
